...
namespace AppVinteUm
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int idade, tipoProduto, qtdFornecidaAoMes;
            ...
            for (int i = 0; i < cliente.Length; i++)
            {
                ...
                cliente[i] = new Cliente(nome, cpf, idade, saldo, tipoCliente);

                try
                {
                    clientedal.insert(new Cliente());
                    cliente[i] = clientedal.getLastRegister();
                    cliente[i] = clientell.getLastRegister();
                }
                finally
                {
                    clientedal.delete(cliente[i]);
                }
            }
            ...
            //    funcionarioll = new FuncionarioBLL();

            //    funcionario[i] = new Funcionario(1, nome, cpf, idade, salarioPorHora, cargo, saldo);

            //    try
            //    {
            //        funcionariodal.insert(new Funcionario());
            //        funcionario[i] = funcionariodal.getLastRegister();
            //        funcionario[i] = funcionarioll.getLastRegister();
            //    }
            //    finally
            //    {
            //        funcionariodal.delete(funcionario[i]);
            //    }
            //}
            ...
            //    sociolll = new SocioBLL();

            //    socio[i] = new Socio(qtdAcoes, 1, nome, cpf, idade, saldo, tipoCliente);

            //    try
            //    {
            //        sociodal.insert(new Socio());
            //        socio[i] = sociodal.getLastRegister();
            //        socio[i] = sociolll.getLastRegister();
            //    }
            //    finally
            //    {
            //        sociodal.delete(socio[i]);
            //    }
            //}
            ...
            //    fornecedorll = new FornecedorBLL();

            //    fornecedor[i] = new Fornecedor(1, nomeEmpresa, cnpj, tipoProduto, qtdFornecidaAoMes);

            //    try
            //    {
            //        fornecedordal.insert(new Fornecedor());
            //        fornecedor[i] = fornecedordal.getLastRegister();
            //        fornecedor[i] = fornecedorll.getLastRegister();
            //    }
            //    finally
            //    {
            //        fornecedordal.delete(fornecedor[i]);
            //    }
            //}
