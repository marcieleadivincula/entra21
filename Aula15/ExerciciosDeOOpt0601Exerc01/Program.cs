...
namespace ExerciciosDeOOpt0601Exerc01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //e) Simule um cliente comprando um ingresso, para isso, mostre todas as possibilidades e pergunte qual deseja comprar, após comprar, agradeça pela preferencia e encerre o programa.
